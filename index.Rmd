...
```{r kcalpergal, fig.cap="", fig.height=5, fig.width=7, dpi=300, fig.align='center', message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE, eval=FALSE}
...
```{r galperkcal, fig.cap="", fig.height=7, fig.width=6, dpi=300, fig.align='center', message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
all.df = transform(all.df, custom.descrip.x = reorder(custom.descrip.x, kcal.per.gal.us))
...
```{r galperkcalcali, fig.cap="", fig.height=7, fig.width=6, dpi=300, fig.align='center', message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
...
```{r galperkcalglobal, fig.cap="", fig.height=7, fig.width=6, dpi=300, fig.align='center', message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
...
```{r galpergprotein, fig.cap="", fig.height=7, fig.width=6, dpi=300, fig.align='center', message=FALSE, warning=FALSE, echo=FALSE, cache=FALSE}
